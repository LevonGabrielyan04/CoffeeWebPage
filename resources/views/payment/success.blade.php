    ...
    <div class = "payment_successful_container open-sans">
        <div class = "payment_successful_main">
            <div class = "payment_successful_texts">
                ...
                <span class = "payment_message">Payment successful!</span>
            </div>
            <div class = "payment_successful_bottom_div">
                <?xml version="1.0" ?><svg style = "width: 150px;" id="Layer_1" style="enable-background:new 0 0 512 512;" version="1.1" viewBox="0 0 512 512" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><style type="text/css">
                .st0{fill:#2BB673;}
